      ...
      <div className="container mx-auto px-4">
        <nav className="flex items-center justify-between h-20">
          ...
          <Link to="/" className="flex items-center gap-2">
            <span
              className={`font-serif font-semibold text-xl ${isScrolled ? "text-foreground" : "text-white"}`}
            >
          ...
          <div className="hidden lg:block">
            <Button
              variant="default"
              className="bg-atos-gold text-atos-blue-deep hover:bg-atos-gold-dark font-medium"
            >
              Fale Conosco
            </Button>
          </div>
