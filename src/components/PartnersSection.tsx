...
const partnerTypes = [
  {
    ...
    description:
      'Conecte sua instituição a uma rede qualificada de clientes e amplie sua distribuição de crédito.',
  },
  {
    icon: Layers,
    title: 'Empresas e Incorporadoras',
    description:
      'Soluções de crédito estruturado para viabilizar projetos e crescimento sustentável.',
  },
  {
    icon: Code,
    title: 'Integradores e Fintechs',
    description:
      'APIs e infraestrutura BaaS para integrar serviços financeiros ao seu ecossistema.',
  },
]
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            >
              ...
              <p className="text-lg text-muted-foreground mb-8 leading-relaxed">
                A Atos Hub oferece oportunidades para bancos, empresas e integradores que buscam
                expandir sua atuação no mercado de crédito estruturado com tecnologia e governança.
              </p>
              <a href="https://cadastro.atoshub.com.br/" target="_blank">
                <Button
                  size="lg"
